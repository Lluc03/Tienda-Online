...
def rects_overlap_2d(ax0, az0, ax1, az1, bx0, bz0, bx1, bz1, eps=1e-6):
    """ Solape de dos rectángulos en XZ (cerrado). """
    no_overlap = (ax1 <= bx0 + eps) or (bx1 <= ax0 + eps) or (az1 <= bz0 + eps) or (bz1 <= az0 + eps)
